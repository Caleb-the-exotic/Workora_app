...
export const nav = [
  ...
  { label: "Leave & Time-Off", to: "/employee/leave", icon: CalendarCheck2 },
...
export function EmployeeLayout({
  ...
  const handleToggleCollapse = () => {
    setCollapsed((prev) => {
      const next = !prev;
      localStorage.setItem("workora-emp-sidebar-collapsed", String(next));
      return next;
    });
  };
          ...
          <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-4 py-3 sm:px-6">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0 space-y-0.5">
                <DynamicBreadcrumbs root="Employee" />
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    onClick={() => navigate({ to: "/employee/notifications" })}
                  >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 rounded-xl shadow-card">
                  <DropdownMenuLabel className="font-normal">
                    ...
                    <p className="text-xs text-muted-foreground">{employee.workEmail}</p>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onSelect={() => navigate({ to: "/employee/profile" })}>
                    <User className="h-4 w-4 mr-2" /> My Profile
                  </DropdownMenuItem>
                  <DropdownMenuItem onSelect={() => navigate({ to: "/employee/settings" })}>
